...
angular.module('jsonTree', []).directive('jsonTree', ['$compile', '$parse', function($compile) {
        return {
            terminal: true,
            replace: false,
            restrict: 'A',
                    ...
                    if (data) {
                        ...
                        angular.forEach(data, function(value, key) {
                            ...
                            if (angular.isObject(value)) {
                                ...
                                if (level === 0) opened = 'open';
                                tree += "<li class='parent " + opened
                                        + "'><a href='#' ng-click='showChilds($event)'>" + key + "</a>";
                                ...
                                tree += "<li class='child'><strong>" + key + ":</strong> " + "<em>" + value + "</em>";
                            }
